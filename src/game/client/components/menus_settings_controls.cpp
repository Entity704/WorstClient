...
void CMenusSettingsControls::OnInterfacesInit(CGameClient *pClient)
{
	...
	m_vBindOptions = {
		...
		{EBindOptionGroup::WEAPON, Localizable("Weapon slot 1"), "+weapon1"},
		{EBindOptionGroup::WEAPON, Localizable("Weapon slot 2"), "+weapon2"},
		{EBindOptionGroup::WEAPON, Localizable("Weapon slot 3"), "+weapon3"},
		{EBindOptionGroup::WEAPON, Localizable("Weapon slot 4"), "+weapon4"},
		{EBindOptionGroup::WEAPON, Localizable("Weapon slot 5"), "+weapon5"},
